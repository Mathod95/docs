---
title: "K8s— KEDA, An Event-driven Autoscaler, Part One"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Mastodon](https://me.dm/@tonylixu)## [Geek Culture](https://medium.com/geekculture?source=post_page---publication_nav-9758482ba857-ea5407c51175---------------------------------------)

[![Geek Culture](https://miro.medium.com/v2/resize:fill:76:76/1*bWAVaFQmpmU6ePTjNIje_A.jpeg)](https://medium.com/geekculture?source=post_page---post_publication_sidebar-9758482ba857-ea5407c51175---------------------------------------)

A new tech publication by Start it up ([https://medium.com/swlh](https://medium.com/swlh)).

![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*BvlDJHklR7i_slSK.png)

Pic from returngis.net
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*iEP_VQyfH6Eeo___.png)

Pic from keda.sh

As you can see from the above diagram, there are three core components of KEDA:

- **The Metrics Adapter:** Itconverts the metrics obtained by the Scaler into a format that HPA can use and passes them to HPA
- **Controller:** Itis responsible for creating and updating an HPA object
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*DbcccXGLSma4nJ8N06Ntng.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*9hsq9bzv7Oofqg7c.PNG)

Pic from developer.ibm.com
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*GnMI9ML-QXOhxvq0iGTUZw.png)

### K8s Cluster Capacity

The KEDA runtime require the following resources in a production-ready setup:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*5X5N8fHBNRU6AO5sI4ff3g.png)
...
For demonstration purpose, I will use `Helm` to install it in this article:
...
[![Geek Culture](https://miro.medium.com/v2/resize:fill:96:96/1*bWAVaFQmpmU6ePTjNIje_A.jpeg)](https://medium.com/geekculture?source=post_page---post_publication_info--ea5407c51175---------------------------------------)

[![Geek Culture](https://miro.medium.com/v2/resize:fill:128:128/1*bWAVaFQmpmU6ePTjNIje_A.jpeg)](https://medium.com/geekculture?source=post_page---post_publication_info--ea5407c51175---------------------------------------)

[Last published Sep 1, 2023](https://medium.com/geekculture/17-things-i-wish-id-done-earlier-as-a-data-engineer-d1aa2e4f0694?source=post_page---post_publication_info--ea5407c51175---------------------------------------)

A new tech publication by Start it up ([https://medium.com/swlh](https://medium.com/swlh)).

## More from Tony and Geek Culture
...
](https://medium.com/?source=post_page---read_next_recirc--ea5407c51175---------------------------------------)