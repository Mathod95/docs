...
[Sitemap](https://itnext.io/sitemap/sitemap.xml)## [ITNEXT](https://itnext.io/?source=post_page---publication_nav-5b301f10ddcd-6ee65667e62b---------------------------------------)

## It’s not 2005 anymore and git offers more than just add, commit, push and pull. Let’s explore all the new, modern git commands, that you should know about

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*tiFIvZnjzArj7wS1cGippw.jpeg)
...
If you search for some problem relating to `git`, you will most likely end up on *StackOverflow* question with answer that has couple thousand upvotes. While this answer will be mostly likely still valid, it very well might be outdated, because it was written 10 years ago. Therefore, there might be a better, simpler, easier way to do it. So, when faced with some `git` issue, I would recommend to check [git docs](https://git-scm.com/) for more recent commands, all of which have a lot of great examples, or to explore `man` pages for lots of flags and options that were added to the good old commands over the years.

*This article was originally posted at* [*martinheinz.dev*](https://martinheinz.dev/blog/109)

You may also like…## [Everything You Can Do With Python’s Bisect Module](https://betterprogramming.pub/everything-you-can-do-with-pythons-bisect-module-40bdaadbc22f?source=post_page-----6ee65667e62b---------------------------------------)

Learn how to optimize search and keep your data sorted in Python with the "bisect" module

betterprogramming.pub

[View original](https://betterprogramming.pub/everything-you-can-do-with-pythons-bisect-module-40bdaadbc22f?source=post_page-----6ee65667e62b---------------------------------------)

CKA | RHCE | DevOps Engineer | Working with Python, Kubernetes, Linux and more | [https://martinheinz.dev/](https://martinheinz.dev/) | [https://ko-fi.com/martinheinz](https://ko-fi.com/martinheinz)

## More from Martin Heinz and ITNEXT
...
](https://medium.com/?source=post_page---read_next_recirc--6ee65667e62b---------------------------------------)