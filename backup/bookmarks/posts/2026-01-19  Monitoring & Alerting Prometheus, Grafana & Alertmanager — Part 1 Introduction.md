---
title: "Monitoring & Alerting: Prometheus, Grafana & Alertmanager — Part 1: Introduction"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Sitemap](https://medium.com/sitemap/sitemap.xml)## [Lydtech Consulting](https://medium.com/lydtech-consulting?source=post_page---publication_nav-44fcf3dfd2cd-ebda2d00dcdc---------------------------------------)

[![Lydtech Consulting](https://miro.medium.com/v2/resize:fill:76:76/1*dYpP0uAYppy14wgTeXI0QA.jpeg)](https://medium.com/lydtech-consulting?source=post_page---post_publication_sidebar-44fcf3dfd2cd-ebda2d00dcdc---------------------------------------)

Head over to Lydtech Consulting at [lydtechconsulting.com](http://lydtechconsulting.com/) for articles by the team on all kinds of interesting areas of software development.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Y-N1GT2gYsgUcxlMzwDEvg.png)
...
[**Part 2: Monitoring Demo**](https://medium.com/@robgolder/monitoring-alerting-prometheus-grafana-alertmanager-part-2-monitoring-demo-b56dd416fd03)
...
[**Part 3: Alerting Demo**](https://medium.com/@robgolder/monitoring-alerting-prometheus-grafana-alertmanager-part-3-alerting-demo-ff4f099ef56b)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*2TwAD2w12Tuu_SegpAi5wQ.png)

Figure 1: Monitoring tools
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*O-sGALMcARiOPai8HNLYgQ.png)

Figure 2: Monitoring Demo
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*mfA_MLB2SCc0tu9-SjKXmw.png)

Figure 3: Spring Boot application
...
Head over to [Lydtech Consulting](https://www.lydtechconsulting.com/) to [read this article](https://www.lydtechconsulting.com/blog-monitoring-demo-pt1.html) and many others on interesting areas of software development.

[![Lydtech Consulting](https://miro.medium.com/v2/resize:fill:96:96/1*dYpP0uAYppy14wgTeXI0QA.jpeg)](https://medium.com/lydtech-consulting?source=post_page---post_publication_info--ebda2d00dcdc---------------------------------------)

[![Lydtech Consulting](https://miro.medium.com/v2/resize:fill:128:128/1*dYpP0uAYppy14wgTeXI0QA.jpeg)](https://medium.com/lydtech-consulting?source=post_page---post_publication_info--ebda2d00dcdc---------------------------------------)

[Last published Jun 1, 2025](https://medium.com/lydtech-consulting/micronaut-6-of-6-kafka-integration-a0799e1e4c88?source=post_page---post_publication_info--ebda2d00dcdc---------------------------------------)

Head over to Lydtech Consulting at [lydtechconsulting.com](http://lydtechconsulting.com/) for articles by the team on all kinds of interesting areas of software development.

Kafka | Java | Resiliency | Spring

## More from Rob Golder and Lydtech Consulting
...
](https://medium.com/?source=post_page---read_next_recirc--ebda2d00dcdc---------------------------------------)