...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*bO3GF_tJsJAM1--dUqiJmw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*_HjmNJmZ4u6Fob9-1OY2Wg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Geo84aci07xxYtxoAYFDTQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*d1yoc3EzUqD9KJFkgExiKQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*5zakBm96qbRm8NMVVjn4Cg.png)
...
```
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*3WJcRSSA8ciavzZSV6S3tw.png)

Spoke Cluster-1

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*q_GGSSwPY8IeSRiJWijlBA.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*KyQWN1houTh8hsGkBrXNKQ.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*wPZS_ZDcs6RwZueCXKspuA.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*_48zYwoJOh8NJrFQzL9akw.png)

Generally, it takes “3 minutes” to automatically reflect changes, but let us sync it manually. So, click “ ***SYNC APPS*** ”>> “ ***SYNC*** ”.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*0WBdiKrFEma1NT4tlWeREA.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*R8GNf43MemqG7tOTFsJfIw.png)

Select both apps.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*ZTX4QhlqSCSfV1E97vNwuA.png)
...
```
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*kMdUe8EqGpB7vgjZtqtRzw.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*w2MO2eReg9ep1hsTWGbFTA.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*fR1qKHwnx31ZOdq7Zbpj_A.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*DXkrTdyQVPw1XQfGbREYog.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*6v-9P6-XNhMkRoYw5HVryw.png)

It clearly skipped the change.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*i5xERy6nTQfslMI_jUdv_A.png)

This can also be seen on UI.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*LwtcYnj8tlq_-pa0vRiq0g.png)

Now click on “ ***sync*** ”>> “ ***synchronize*** ”.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*prrqz1mKf4Gb0nh3_XIYPg.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*fRWw92YqkmoaMXkc6dHcaw.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*ygCE1PRxP2ZGuUaO2DowOg.png)

Now because we used “ ***sync*** ” the change was rolled back in the configmap. (from “ ***user*** ” to “ ***sarat*** ”).

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Ie3w45W7zFQsuITWbAkQ9Q.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Vo4MC7ykXPB0qJlbevGwdw.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Mj73gFGPI606L2gaEpH7JA.png)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*4jJkZ913KMtJuixhRXj0vA.png)
