---
title: "Velero: A Tale of Best Practices for Kubernetes Backup, Restore, and Migration"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*YDhDXoSIQ2cyoZwZl8v7fQ.png)
...
```
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*X0wL9_sGAZDJqT9JCQ5cHw.png)
...
```
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*zGXRigcz2YgPCmJRpK_vLA.png)
...
![](https://miro.medium.com/v2/format:webp/1*Seyo6Oo609d96FHcuz1XFQ.png)
...
### References## [\[1\] — Basic Install](https://velero.io/docs/v1.3.1/basic-install/?source=post_page-----cff58653aa0e---------------------------------------)

Use this doc to get a basic installation of Velero. Refer this document to customize your installation. Access to a…

velero.io

[View original](https://velero.io/docs/v1.3.1/basic-install/?source=post_page-----cff58653aa0e---------------------------------------)## [\[2\] — Backup and restore your Amazon EKS cluster resources using Velero | Amazon Web Services](https://aws.amazon.com/blogs/containers/backup-and-restore-your-amazon-eks-cluster-resources-using-velero/?source=post_page-----cff58653aa0e---------------------------------------)

September 9th, 2023: This post was originally published December 1, 2021. We've updated the walkthrough instructions of…

aws.amazon.com

[View original](https://aws.amazon.com/blogs/containers/backup-and-restore-your-amazon-eks-cluster-resources-using-velero/?source=post_page-----cff58653aa0e---------------------------------------)## [\[3\] — Uninstalling Velero](https://velero.io/docs/v1.3.0/uninstalling/?source=post_page-----cff58653aa0e---------------------------------------)

Documentation for version v1.3.0 is no longer actively maintained. The version you are currently viewing is a static…

velero.io

[View original](https://velero.io/docs/v1.3.0/uninstalling/?source=post_page-----cff58653aa0e---------------------------------------)

Cloud Native & DevOps Engineer

## More from Rumeysa Kumru
...
](https://medium.com/?source=post_page---read_next_recirc--cff58653aa0e---------------------------------------)