---
title: "Why I prefer Kyverno over Gatekeeper for native Kubernetes policy management"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
## I used to use Open Policy Agent Gatekeeper for Kubernetes policies but personally found writing new policies to be quite difficult with a steep learning curve. I then decided to give Kyverno a try and was really impressed with how easy it was to use.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*U4vnl2qoXBNzOFeMrkR87A.png)
...
Not so fast! While Kyverno is more user friendly, it is only for Kubernetes. Open Policy Agent and Gatekeeper, on the other hand, has been around longer and can extend its capabilities beyond just Kubernetes. For instance, [Azure Policy for AKS](https://learn.microsoft.com/en-us/azure/governance/policy/concepts/policy-for-kubernetes) and Google Cloud’s Anthos [Policy Controller](https://cloud.google.com/anthos-config-management/docs/concepts/policy-controller) are both based on Gatekeeper, as well as [Forseti](https://forsetisecurity.org/) (though now sunset/archived). The choice between the two depends on your existing tooling for managing organizational policies and the platforms you currently use or intend to adopt.
...
Principal Consultant | Google Developer Expert (Cloud & AI/ML) | Google Developer Advisory Board (gDAB) member
...
](https://medium.com/?source=post_page---read_next_recirc--35a05bb94964---------------------------------------)