...
[Sitemap](https://kamsjec.medium.com/sitemap/sitemap.xml)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*bW9zleUvj0OBMNeLRuqphw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*PQepeMoVPr3O4f2uBTboew.png)

I tried putting as simple as possible about the probes..

Happy learning…

**References**:## [Best practices: Using health checks in the OpenShift 4.5 web console | Red Hat Developer](https://developers.redhat.com/blog/2020/07/20/best-practices-using-health-checks-in-the-openshift-4-5-web-console?source=post_page-----91919f24e305---------------------------------------#probe_types)

For an enterprise application to succeed, you need many moving parts to work correctly. If one piece breaks, the system…

developers.redhat.com

[View original](https://developers.redhat.com/blog/2020/07/20/best-practices-using-health-checks-in-the-openshift-4-5-web-console?source=post_page-----91919f24e305---------------------------------------#probe_types)## [Configure Liveness, Readiness and Startup Probes](https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/?source=post_page-----91919f24e305---------------------------------------)

This page shows how to configure liveness, readiness and startup probes for containers. The kubelet uses liveness…

kubernetes.io

[View original](https://kubernetes.io/docs/tasks/configure-pod-container/configure-liveness-readiness-startup-probes/?source=post_page-----91919f24e305---------------------------------------)

DevSecOps Practitioner (CKA certified, RHOCP Certified, Azure Certified on az-104,az-400,az-303.), AIOps, MCP, and GenAI

## More from Kamlesh Prajapati
...
](https://medium.com/?source=post_page---read_next_recirc--91919f24e305---------------------------------------)