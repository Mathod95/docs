...
![](../assets/images/crossplane/crossplane-horizontal-color.svg)
...
```embed
url: https://docs.crossplane.io/v2.1/guides/upgrade-to-crossplane-v2/
```

```embed
url: https://docs.crossplane.io/v2.1/whats-new/
```
</div>