---
title: "How to Write a Kubernetes Operator"
date: 2026-01-18
categories:
  - "uncategorized"
tags:
  - "untagged"
source: "https://itnext.io/how-to-write-a-kubernetes-operator-5f98f7ef9f75"
author:
  - "[[Payam Qorbanpour]]"
---
<!-- more -->

[Sitemap](https://itnext.io/sitemap/sitemap.xml)## [ITNEXT](https://itnext.io/?source=post_page---publication_nav-5b301f10ddcd-5f98f7ef9f75---------------------------------------)

![Kubernetes Operator](https://miro.medium.com/v2/resize:fit:640/format:webp/1*bPuZj4i3fv7uxqelc7Vqaw.png)
...
After all, with the help of [this series](https://www.codereliant.io/build-kubernetes-operator-kubebuilder/) I managed to write another Kubernetes operator from the tutorials:) but this time, it was different.## [Hands-on Kubernetes Operator Development: Kubebuilder](https://www.codereliant.io/build-kubernetes-operator-kubebuilder/?source=post_page-----5f98f7ef9f75---------------------------------------)

Learn how to develop a Kubernetes Operator from scratch with this hands-on kubebuilder tutorial.

www.codereliant.io

[View original](https://www.codereliant.io/build-kubernetes-operator-kubebuilder/?source=post_page-----5f98f7ef9f75---------------------------------------)
...
I opened an [issue](https://github.com/gobackup/gobackup/issues/231) and proposed a repository under the [gobackup organization](https://github.com/gobackup), and the openness to collaborate was still present.
...
Fortunately, I already had `Golang`, `Docker`, and `kubectl` installed on my computer. Through previous practices, I had become familiar with local machine Kubernetes clusters like `Kind` and tools for creating operators such as `kubebuilder`.
...
Remember modifying *POSTGRES\_USER* and *POSTGRES\_PASSWORD* in the manifest and the apply it:
...
> If you found this post charming then **clap**, **comment and follow** for more**.**

To give meaning to the world as much as I can.

## More from Payam Qorbanpour and ITNEXT
...
](https://medium.com/?source=post_page---read_next_recirc--5f98f7ef9f75---------------------------------------)