---
title: "Optimizing ArgoCD for Monorepo setup"
date: 2026-01-18
categories:
  - "uncategorized"
tags:
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*GD9OktU4NQ_azjh9AnqcBw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*Q_vhyaoEwYTPmInA.jpg)

ArgoCD as ArgoCD Application

### How does it work together

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*ICV0jOCRLV3-0hatT6It6w.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*jXPC7W-4EhaQ3eyt0C49xw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*mi0W5yhiGXjTuH5NNAHu_w.png)
...
- Trigger action on push to `main` branch and a specific path corresponding to the evironment
- Use [https://github.com/tj-actions/changed-files](https://github.com/tj-actions/changed-files) action to detect added, modified and removed files
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*3GAb2YZgRX9DF2u0)
...
](https://medium.com/?source=post_page---read_next_recirc--7c5f548e5575---------------------------------------)