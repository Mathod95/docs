---
title: "8 tips to incredibly boost the efficiency of command execution on Kubernetes using k9s"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Mastodon](https://me.dm/@gavin_fong)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*LCKauT3SLTeRoG1IKla4mw.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*iWvk84WGFMdHSvDd)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*ENhagtVwqM0Qh_YR)

get k8s resource by type
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*MGHBf8wghq-5UCkR)

auto completion

Likewise, ***:deploy*** shows the deployment resource

![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*3XvB3xzEN7NTJWTD)

k8s deployment

***:svc*** gets service

![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*JgC-KBtDuU0UTyJg)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*YGWtLg-J9DJHbv8C)

shortcut keys to namespaces
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*AzbUZ8YWdm_2EQ9m)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*TvcqRCNrXqaCVmpG)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*PX_PXv_bJsPxSpgM)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*94i1N2UbIIRNy-dx)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*L6a2OWt0yVzbqFcr)

port forward

“F” icon is shown under the PF column once port forward is enabled.

![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*bGddWgwXp_gzuHKP)

pod with port forward enabled
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*Qx2O87l7ynuVkBfE)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*0gp6ZmoW2LcXhBpr)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*B7CouFvxj70UiSZr)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*CKqFMTVHDIUlhAUQ)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*EM-i4Odx92YN0xeK)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*Quro1DlIdfMdqz-d)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*FrH72LxqTsCZ7QJ2)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*_dGxF6qzANG3LDJq)

configmap content

Another cool feature is the hotkey “u” to check the list of k8s resources which are using the the configmap / secret item

![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*SPASlxg4dKzGhZD9)

check “usedby” of configmap
...
Backend engineer sharing insights on scalable systems, Kafka, Cassandra, and cloud-native tools. Follow for practical guides and tips.
...
](https://medium.com/?source=post_page---read_next_recirc--a515a90a3a27---------------------------------------)