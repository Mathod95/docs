---
title: "Argo CD v2.11 Release Candidate"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Sitemap](https://blog.argoproj.io/sitemap/sitemap.xml)## [Argo Project](https://blog.argoproj.io/?source=post_page---publication_nav-21be29067291-b83ba3008ba5---------------------------------------)

[![Argo Project](https://miro.medium.com/v2/resize:fill:76:76/1*ZJ10oT9u3uqJVT-Rkyb0bQ.png)](https://blog.argoproj.io/?source=post_page---post_publication_sidebar-21be29067291-b83ba3008ba5---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*gguIsZv15HrjXDPG)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*zDXXZS6fYTlnA0VU)
...
- The [Apps in any namespace feature](https://argo-cd.readthedocs.io/en/latest/operator-manual/app-any-namespace/) has been [promoted from beta to stable](https://github.com/argoproj/argo-cd/pull/17529)
...
- Add [maxPodLogsToRender](https://github.com/argoproj/argo-cd/pull/14617) setting (By [Lukas](https://github.com/lukaszgyg))
...
For more details and installation instructions, check the , and [upgrade instructions](https://argo-cd.readthedocs.io/en/latest/operator-manual/upgrading/2.10-2.11/). Please try the release candidate and share your feedback. A big thanks to all Argo Community contributors and users for their contributions, feedback, and help in testing the release!

Photo by [Lora Seis](https://unsplash.com/@diasplora?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash) on [Unsplash](https://unsplash.com/photos/a-stuffed-animal-with-a-hat-dS5xpjW38Qk?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash)
...
## More from Kostis Kapelonis and Argo Project
...
](https://medium.com/?source=post_page---read_next_recirc--b83ba3008ba5---------------------------------------)