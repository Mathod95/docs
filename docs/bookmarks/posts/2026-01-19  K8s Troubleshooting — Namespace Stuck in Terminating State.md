---
title: "K8s Troubleshooting — Namespace Stuck in Terminating State"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Sitemap](https://blog.devgenius.io/sitemap/sitemap.xml)

[Mastodon](https://me.dm/@tonylixu)## [Dev Genius](https://blog.devgenius.io/?source=post_page---publication_nav-4e2c1156667e-b91ab6fa8948---------------------------------------)

![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*fddruQCl6W-9J-7s.png)

> N ***ote, full “K8s Troubleshooting” mind map is available at: “*** [***K8s Troubleshooting Mind Map***](https://github.com/metaleapca/metaleap-k8s-troubleshooting/blob/main/metaleap-k8s-troubleshooting.pdf) ***”***
...
You can run the `kubectl get ns <namespace_name> -oyaml` to find out if there are any error messages:
...
Notice that in above output, these namespaces have a `finalizer` defined under `spec`. In K8s, a `finalizer` is a special metadata key that tells K8s to wait until a specific condition is met before it fully deletes a resource.
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*pPc0jv0a-ri_ow9Xxg76JQ.png)

## More from Tony and Dev Genius
...
](https://medium.com/?source=post_page---read_next_recirc--b91ab6fa8948---------------------------------------)