---
title: "Set up a multi node Kubernetes cluster locally - using KinD"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Sitemap](https://mcvidanagama.medium.com/sitemap/sitemap.xml)
...
You must have docker installed and running. You can select and follow the documentation as per your OS.## [Install Docker Engine](https://docs.docker.com/engine/install/?source=post_page-----eafd46dd63e5---------------------------------------)

Docker Engine is available on a variety of Linux platforms, macOS and Windows 10 through Docker Desktop, and as a…

docs.docker.com

[View original](https://docs.docker.com/engine/install/?source=post_page-----eafd46dd63e5---------------------------------------)

### 2\. Install kubectl

Installing kubectl on your local machine will let you access the cluster from your local machine.

Follow [this documentation](https://kubernetes.io/docs/tasks/tools/install-kubectl/) to install and setup kubectl.## [Install and Set Up kubectl](https://kubernetes.io/docs/tasks/tools/install-kubectl/?source=post_page-----eafd46dd63e5---------------------------------------)

The Kubernetes command-line tool, kubectl, allows you to run commands against Kubernetes clusters. You can use kubectl…

kubernetes.io

[View original](https://kubernetes.io/docs/tasks/tools/install-kubectl/?source=post_page-----eafd46dd63e5---------------------------------------)
...
```c
brew install kind
```## [Quick Start](https://kind.sigs.k8s.io/docs/user/quick-start/?source=post_page-----eafd46dd63e5---------------------------------------#installation)

This guide covers getting started with the kind command. If you are having problems please see the known issues guide…

kind.sigs.k8s.io

[View original](https://kind.sigs.k8s.io/docs/user/quick-start/?source=post_page-----eafd46dd63e5---------------------------------------#installation)

### 3\. Add kind to PATH variable

This is not mandatory, but once this is done you can run ‘kind’ commands from anywhere without pointing to the executable. Therefore lets just add the executable to the PATH. I added below two lines in my ~/.bash\_profile file. Im using a Mac.
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*7P-oRRd5PXjXvBKtvXV-ow.png)
...
docker ps
```
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Q-q4SqT-0peiXVhfAZwa8A.png)
...
And also if you are preparing for any exams like CKA,CKAD and CKS. This will be really helpfull during the exam. Therefore please take sometime to setup auto completion and alias for kubectl depending on your OS.## [kubectl Cheat Sheet](https://kubernetes.io/docs/reference/kubectl/cheatsheet/?source=post_page-----eafd46dd63e5---------------------------------------#kubectl-autocomplete)

This page contains a list of commonly used kubectl commands and flags. Kubectl autocomplete BASH source > ~/.bashrc #…

kubernetes.io

[View original](https://kubernetes.io/docs/reference/kubectl/cheatsheet/?source=post_page-----eafd46dd63e5---------------------------------------#kubectl-autocomplete)

Im using a MacBook Pro, Steps in the above link didnt work for me for some reason. Then I found and followed the below blog post. It works fine for me.## [Kubectl autocompletion in MacOS](https://varlogdiego.com/kubectl-autocompletion-in-macos?source=post_page-----eafd46dd63e5---------------------------------------)

MacOS comes with a really old bash version. Check the version from the environment variable.. $ echo $BASH\_VERSION…

varlogdiego.com

[View original](https://varlogdiego.com/kubectl-autocompletion-in-macos?source=post_page-----eafd46dd63e5---------------------------------------)
...
](https://medium.com/?source=post_page---read_next_recirc--eafd46dd63e5---------------------------------------)