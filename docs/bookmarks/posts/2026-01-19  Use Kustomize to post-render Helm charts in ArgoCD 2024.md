---
title: "Use Kustomize to post-render Helm charts in ArgoCD 2024"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Sitemap](https://quannhm.medium.com/sitemap/sitemap.xml)
...
I have a Helm snippet on the Internet that creates a `ConfigMap` and doesn’t support adding annotations. To overcome this problem, I will use `Kustomize` to render the helm chart in multiple steps. You can see more about this techniques at
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*xcWSGIIpqX9HhAOAUJNqZg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*Iwy9L6GIQzIjs6E2tqyZ7w.png)

## More from Nguyễn Hoàng Minh Quân
...
](https://medium.com/?source=post_page---read_next_recirc--55cc1927ac32---------------------------------------)