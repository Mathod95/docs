---
title: "What Are Kubernetes Node Affinity and Pod Affinity?"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Mastodon](https://me.dm/@luishrsoares)## [Cloud Native Daily](https://medium.com/cloud-native-daily?source=post_page---publication_nav-dd347d5c5a2b-5898ddcbc96a---------------------------------------)

[![Cloud Native Daily](https://miro.medium.com/v2/resize:fill:76:76/1*MoZ3voEYDtTTwoQ3azpccg.png)](https://medium.com/cloud-native-daily?source=post_page---post_publication_sidebar-dd347d5c5a2b-5898ddcbc96a---------------------------------------)

A blog for Devs and DevOps covering tips, tools, and developer stories about all things cloud-native

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*cOeI5aCulMdZzb6t8RVU6g.png)
...
### Further Reading:## [Kubernetes Monitoring with OpenTelemetry](https://gethelios.dev/blog/kubernetes-monitoring-opentelemetry/?utm_source=medium&utm_medium=cloud+native+daily&source=post_page-----5898ddcbc96a---------------------------------------)

Learn how to monitor Kubernetes using OpenTelemetry with real-time visibility and granular error data — Reduce MTTR by…

gethelios.dev

[View original](https://gethelios.dev/blog/kubernetes-monitoring-opentelemetry/?utm_source=medium&utm_medium=cloud+native+daily&source=post_page-----5898ddcbc96a---------------------------------------)## [OpenTelemetry: A full guide](https://gethelios.dev/opentelemetry-a-full-guide/?utm_source=medium&utm_medium=cloud+native+daily&source=post_page-----5898ddcbc96a---------------------------------------)

Learn all about OpenTelemetry OpenSource and how it transforms microservices observability and troubleshooting

gethelios.dev

[View original](https://gethelios.dev/opentelemetry-a-full-guide/?utm_source=medium&utm_medium=cloud+native+daily&source=post_page-----5898ddcbc96a---------------------------------------)## [Kubernetes Monitoring](https://medium.com/cloud-native-daily/kubernetes-monitoring-d0ab5563f10f?source=post_page-----5898ddcbc96a---------------------------------------)

A Comprehensive Guide to Kubernetes Monitoring

medium.com

[View original](https://medium.com/cloud-native-daily/kubernetes-monitoring-d0ab5563f10f?source=post_page-----5898ddcbc96a---------------------------------------)

[![Cloud Native Daily](https://miro.medium.com/v2/resize:fill:96:96/1*MoZ3voEYDtTTwoQ3azpccg.png)](https://medium.com/cloud-native-daily?source=post_page---post_publication_info--5898ddcbc96a---------------------------------------)

[![Cloud Native Daily](https://miro.medium.com/v2/resize:fill:128:128/1*MoZ3voEYDtTTwoQ3azpccg.png)](https://medium.com/cloud-native-daily?source=post_page---post_publication_info--5898ddcbc96a---------------------------------------)

[Last published Apr 4, 2025](https://medium.com/cloud-native-daily/serverless-video-transcoding-on-aws-using-lambda-mediaconvert-and-cloudfront-b4103ec16d49?source=post_page---post_publication_info--5898ddcbc96a---------------------------------------)

A blog for Devs and DevOps covering tips, tools, and developer stories about all things cloud-native

Lead Software Engineer | Blockchain & ZKP Protocol Engineer | 🦀 Rust | Web3 | Solidity | Golang | Cryptography | Author

## More from Luis Soares and Cloud Native Daily
...
](https://medium.com/?source=post_page---read_next_recirc--5898ddcbc96a---------------------------------------)