---
title: "Why use DNS ALIAS record instead of CNAME in the Cloud?"
date: 2026-01-19
categories:
  - "uncategorized"
tags:
...
[Sitemap](https://adil.medium.com/sitemap/sitemap.xml)

Having a custom domain on top of a cloud resource is essential.

**\*\*\*\*\*** [**You can follow me on LinkedIn**](https://www.linkedin.com/posts/adililhan_cloud-aws-cloudsecurity-activity-7193134936143396865-qdco/) **\*\*\*\*\***

![](https://miro.medium.com/v2/resize:fit:640/format:webp/0*jFESz-2oT_BmdxD7)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*bAf6XT-Qt0F6cofClx0g1w.png)

I added the load balancer’s domain name as a CNAME to my domain:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*HjqMdxQVmZQaDT4iK7xR-g.png)

Just for testing, I will send a request:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*UVPvzeYjjOqtxtnvVjMztw.png)

I received a response from the AWS resource (an EC2 instance).

I will delete the load balancer and see what happens:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*8Q8gHgp9riB_hpuUVNhtyw.png)

DNS Result:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*cGysWsSYEeoemq5lBHGGTA.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*GHCbbdaid-IptCU8YQ9FOA.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*YJzVt6fKiG_B9BjOycyWBA.png)

Check the DNS:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*d1wzjN10FLEjD_1j-BNemQ.png)

As a result, the attacker cannot determine the load balancer's domain name.

For testing purposes, I will send a request:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*OnYQ7e-Q3kbe6w1BxvWlgA.png)

I deleted the load balancer:

![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*5h3jWTxjtV0dS-OtTLFMbg.png)
...
![](https://miro.medium.com/v2/resize:fit:640/format:webp/1*3wPVvnfgHyPUQg9csA2UTg.png)
...
](https://medium.com/?source=post_page---read_next_recirc--ca995b7a364d---------------------------------------)